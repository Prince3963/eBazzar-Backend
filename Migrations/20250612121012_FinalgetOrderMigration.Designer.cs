...
namespace eBazzar.Migrations
{
    ...
    [Migration("20250612121012_FinalgetOrderMigration")]
    partial class FinalgetOrderMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orders", b =>
                {
                    b.HasOne("eBazzar.Model.Payments", null)
                        .WithMany("orders")
                        .HasForeignKey("Paymentspayment_id");

                    b.HasOne("eBazzar.Model.Address", null)
                        .WithMany("orders")
